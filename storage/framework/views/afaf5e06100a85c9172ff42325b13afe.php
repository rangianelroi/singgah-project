...
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('heroicon-m-queue-list'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                        <?php echo e($this->getItems()->total()); ?> item menunggu
                    </span>
                </div>
            </div>
         <?php $__env->endSlot(); ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if($this->getItems()->isNotEmpty()): ?>
                        ...
                        <div class="p-5 flex-grow relative z-10">
                            <div class="flex items-start justify-between gap-3 mb-4">
                                <span class="inline-flex items-center rounded-full px-3 py-1 text-xs font-bold text-black shadow-md transform transition-all duration-200 group-hover:scale-105"
                                      style="background: linear-gradient(135deg, <?php echo e(\App\Models\ConfiscatedItem::getCategoryColor($item->category)); ?> 0%, <?php echo e(\App\Models\ConfiscatedItem::getCategoryColor($item->category)); ?>dd 100%); box-shadow: 0 4px 12px <?php echo e(\App\Models\ConfiscatedItem::getCategoryColor($item->category)); ?>40;">
                                    <?php echo e(str_replace('_', ' ', Str::title(strtolower($item->category)))); ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                                    <span class="whitespace-nowrap"><?php echo e($item->created_at->diffForHumans(['short' => true])); ?></span>
                                </div>
                            </div>
...
<?php endif; ?>
                                ...
                                <div class="min-w-0 flex-1">
                                    ...
                                    <p class="text-xs font-bold text-gray-900 dark:text-white truncate">
                                        <?php echo e($item->passenger->full_name ?? 'N/A'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['color' => 'primary','size' => 'sm','icon' => 'heroicon-m-archive-box-arrow-down','wire:click' => 'mountAction(\'storeItem\', { record: \''.e($item->id).'\' })','class' => 'shadow-md hover:shadow-lg transition-all duration-200']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'primary','size' => 'sm','icon' => 'heroicon-m-archive-box-arrow-down','wire:click' => 'mountAction(\'storeItem\', { record: \''.e($item->id).'\' })','class' => 'shadow-md hover:shadow-lg transition-all duration-200']); ?>
                                Proses
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                            ...
                            <?php if (isset($component)) { $__componentOriginal6330f08526bbb3ce2a0da37da512a11f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6330f08526bbb3ce2a0da37da512a11f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['color' => 'gray','size' => 'sm','tag' => 'a','href' => ''.e(\App\Filament\Resources\ConfiscatedItems\ConfiscatedItemResource::getUrl('view', ['record' => $item])).'','target' => '_blank','icon' => 'heroicon-m-eye','outlined' => true,'class' => 'shadow-sm hover:shadow-md transition-all duration-200']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('filament::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'gray','size' => 'sm','tag' => 'a','href' => ''.e(\App\Filament\Resources\ConfiscatedItems\ConfiscatedItemResource::getUrl('view', ['record' => $item])).'','target' => '_blank','icon' => 'heroicon-m-eye','outlined' => true,'class' => 'shadow-sm hover:shadow-md transition-all duration-200']); ?>
                                Detail
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal6330f08526bbb3ce2a0da37da512a11f)): ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-10 h-10 text-primary-600 dark:text-primary-400']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php endif; ?><?php /**PATH C:\Users\ElroiJohanes\Documents\singgah\singgah-project\resources\views/filament/widgets/storage-management-widget.blade.php ENDPATH**/ ?>