            ...
            <div class="mb-6 flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <input 
                        ...
                        <?php if(count($selectedItems) === count($this->getItems()) && count($this->getItems()) > 0): echo 'checked'; endif; ?>
                    ...
                    <span class="text-sm font-medium text-gray-700 dark:text-gray-300 cursor-pointer" wire:click="toggleSelectAll">
                        Pilih Semua (<?php echo e(count($selectedItems)); ?>/<?php echo e(count($this->getItems())); ?>)
                    </span>
                </div>
...
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('heroicon-m-archive-box'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                        Masuk Gudang (<?php echo e(count($selectedItems)); ?>)
                    </button>
                        ...
                        <div class="p-6 flex-grow pt-12">
                            ...
                            <div class="flex items-start justify-between gap-3 mb-5">
                                <span class="inline-flex items-center rounded-lg px-3 py-1.5 text-xs font-semibold text-white shadow-sm"
                                      style="background-color: <?php echo e(\App\Models\ConfiscatedItem::getCategoryColor($item->category)); ?>;">
...
<?php endif; ?>
                            ...
                            <div class="pb-5 mb-5 border-b border-gray-100 dark:border-gray-700">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($item->item_quantity): ?>
                                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">
                                        <span class="font-medium"><?php echo e($item->item_quantity); ?></span>
                                        <span class="ml-1"><?php echo e($item->item_unit); ?></span>
                                    </p>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </div>
...
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('heroicon-m-paper-airplane'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
...
<?php endif; ?>
                                    ...
                                    <div class="min-w-0 flex-1">
                                        ...
                                        <p class="text-sm font-semibold text-gray-900 dark:text-white truncate">
                                            <?php echo e($item->flight->airline->code ?? ''); ?> <?php echo e($item->flight->flight_number ?? 'N/A'); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'success','icon' => 'heroicon-m-check-circle','class' => 'flex-1','wire:click' => 'mountAction(\'approveAction\', { record: '.e($item->id).' })']); ?>
                                    Verifikasi
                                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                ...
                                <?php if (isset($component)) { $__componentOriginal6330f08526bbb3ce2a0da37da512a11f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6330f08526bbb3ce2a0da37da512a11f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['color' => 'gray','size' => 'sm','tag' => 'a','href' => ''.e(\App\Filament\Resources\ConfiscatedItems\ConfiscatedItemResource::getUrl('view', ['record' => $item])).'','target' => '_blank','icon' => 'heroicon-m-eye','outlined' => true,'class' => 'flex-1']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('filament::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'gray','size' => 'sm','tag' => 'a','href' => ''.e(\App\Filament\Resources\ConfiscatedItems\ConfiscatedItemResource::getUrl('view', ['record' => $item])).'','target' => '_blank','icon' => 'heroicon-m-eye','outlined' => true,'class' => 'flex-1']); ?>
                                    Detail
                                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal6330f08526bbb3ce2a0da37da512a11f)): ?>
        ...
        <?php else: ?>
            ...
            <div class="text-center py-12">
                <div class="inline-flex items-center justify-center w-16 h-16 rounded-full mb-4"
                     style="background-color: <?php echo e($this->search ? '#FEE2E2' : '#F3F4F6'); ?>;">
...
<?php endif; ?><?php /**PATH C:\Users\ElroiJohanes\Documents\singgah\singgah-project\resources\views/filament/widgets/pending-verification-widget.blade.php ENDPATH**/ ?>