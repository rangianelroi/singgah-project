...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                        <?php echo e(count($inStorageItems)); ?> barang menunggu
                    </span>
                </div>
            </div>
         <?php $__env->endSlot(); ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if(count($inStorageItems) > 0): ?>
            <div class="flex flex-col gap-4">
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $inStorageItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                                    <span class="whitespace-nowrap"><?php echo e($item->storage_location ?? 'N/A'); ?></span>
                                </div>
                            </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['color' => 'info','size' => 'sm','wire:click' => 'mountAction(\'processShipmentAction\', { record: '.e($item->id).' })','icon' => 'heroicon-o-play-circle','class' => 'shadow-sm hover:shadow-md transition-all duration-200']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'info','size' => 'sm','wire:click' => 'mountAction(\'processShipmentAction\', { record: '.e($item->id).' })','icon' => 'heroicon-o-play-circle','class' => 'shadow-sm hover:shadow-md transition-all duration-200']); ?>
                                Proses
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH C:\Users\ElroiJohanes\Documents\singgah\singgah-project\resources\views/filament/widgets/in-storage-items-widget.blade.php ENDPATH**/ ?>